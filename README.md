...
- **Free evaluation sample** on GitHub (`30m`) · **11 timeframes** on [getdata.finance](https://getdata.finance/datasets/eurjpy) · **308,003** `30m` rows in the full archive
...
| time | open | high | low | close | volume |
| --- | --- | --- | --- | --- | --- |
| 2026-09-02T00:00:00+00:00 | 185.68 | 185.688 | 185.595 | 185.609 | 14001 |
| 2026-09-02T00:30:00+00:00 | 185.609 | 185.684 | 185.597 | 185.665 | 12330 |
| 2026-09-02T01:00:00+00:00 | 185.665 | 185.691 | 185.638 | 185.646 | 8131 |
| 2026-09-02T01:30:00+00:00 | 185.646 | 185.693 | 185.624 | 185.689 | 7238 |
...
df = pd.read_csv('EURJPY_30m.csv', parse_dates=['time'])
...
The complete **EURJPY** archive on **[getdata.finance](https://getdata.finance/datasets/eurjpy)** includes **11 OHLCV timeframes** (1m · 3m · 5m · 15m · 30m · 1H · 4H · 12H · 1D · 3D · 1W) — **308,003** rows at `30m`, plus all other timeframes in the same ZIP.
